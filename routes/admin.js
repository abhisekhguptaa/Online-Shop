...
router.post("/add-product", isAuth, adminController.postAddProduct); // post the add-product page
...
//it'll be fired when the form is submitted (POST request)
router.post("/edit-product", isAuth, adminController.postEditProduct); // post the edit-product page

//it'll be fired when the user visits /admin/delete-product (POST request)
router.post("/delete-product", isAuth, adminController.postDeleteProduct); // delete the product
